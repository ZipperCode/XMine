...
object DeJianHooker {
    ...
    private fun hookRealTime() {
        ...
        Logger.d("hookKwAd#cls = %s", cls)
        XposedHelpers.findAndHookMethod(cls, "isDebuggable", object : XC_MethodHook() {
            override fun afterHookedMethod(param: MethodHookParam?) {
                param?.result = true
            }
        })

        XposedHelpers.findAndHookMethod(cls, "getReadTime", object : XC_MethodHook() {
            override fun afterHookedMethod(param: MethodHookParam?) {
    ...
    private fun hookVipTime() {
        ...
        XposedBridge.hookMethod(getLongMethod, object : XC_MethodHook() {
            override fun afterHookedMethod(param: MethodHookParam?) {
                super.afterHookedMethod(param)
